...
calcAmount = function(){
    ...
    //console.log(`This is loanAmount ${loanAmount}`);
...
function calculate(startingLoanAmount, totalPayments, interestRate, downPay)
{
    ...
    payment = (interestRatePerMonth * Number(startingLoanAmount)) * Math.pow((1 + interestRatePerMonth), Number(totalPayments)) / (Math.pow((1 + interestRatePerMonth), Number(totalPayments))-1);
    ...
    genRA2(totalPayments, price, rate, payment);
...
genRA2 = function(totalPayments, loanAmt, yrRate, payment){
